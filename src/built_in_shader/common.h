...
inline constexpr const char* ObjectPickingInstances = "ObjectPickingInstances";
inline constexpr const char* HeadBuffer = "HeadBuffer";
inline constexpr const char* NodePool = "NodePool";
inline constexpr const char* VertexPickingParams = "VertexPickingParams";
