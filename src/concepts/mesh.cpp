...
MeshDeprecated::MeshDeprecated(VkWrappedInstance* i, const std::vector<VERT_COMP>& cs, bool indexed)
    : ins(i)
    , comps(cs)
    , indexed(indexed)
{
...
MeshDeprecated::MeshDeprecated(const MeshDeprecated& b) {
    ins = b.ins;
    comps = b.comps;
    indexed = b.indexed;
...
MeshDeprecated::MeshDeprecated(MeshDeprecated&& b) {
    ins = b.ins;
...
void MeshDeprecated::load(aiMesh *mesh) {
...
void MeshDeprecated::load(const uint32_t v, const char* vdata, const uint32_t vsize,
...
void MeshDeprecated::set_view(uint32_t v, void* vview, uint32_t i, void* iview) {
...
void MeshDeprecated::unload_gpu() {
...
void MeshDeprecated::emit_draw_cmd(VkCommandBuffer cmd_buf, VkPipelineLayout ppl_layout,
...
void MeshDeprecated::emit_draw_cmd(CommandBuffers& cbufs, const uint32_t idx, PipelineMgr& ppl_mgr,
