...
static bool reflect_shader_module(ShaderModule& mod, const VkShaderStageFlagBits t) {
    mod.buf_infos.clear();
    mod.img_infos.clear();
...
static bool shader_kind_from_stage(const VkShaderStageFlagBits t, shaderc_shader_kind& out_kind) {
    switch (t) {
...
bool ShaderModule::load(const char* source, const VkShaderStageFlagBits t,
